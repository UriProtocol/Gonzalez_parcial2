...
<head>
    <meta charset="UTF-8">
    <meta http-equiv="refresh" content="0;https://uriprotocol.projectsutd.online/login">
    <title>Redireccionando</title>
</head>
<body>
    <p>Si no eres redireccionado automáticamente, sigue este<a href="destination.html"> link a la nueva página</a>.</p>
</body>
</html>
<!--<!DOCTYPE html>
<html lang="es">
        ...
        <div class="content">
            ...
            <div class="link-container">
                <a 
                    ...
                    target="_blank"
                >
                    ¿Cómo puedo migrar un sitio web a Hostinger? 
                ...
                <a 
                    ...
                    target="_blank"
                >
                    ¿Cómo instalar WordPress usando el instalador automático?
                    <svg class="ic-launch" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path 
                            fill-rule="evenodd" 
                            clip-rule="evenodd" 
